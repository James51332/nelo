...
void lua_types::create_types(sol::state_view lua, sol::table binding)
{
  ...
  binding.new_usertype<glm::vec2>("vec2", sol::constructors<glm::vec2(float, float)>(), "x",
                                  &glm::vec2::x, "y", &glm::vec2::y);

  binding.new_usertype<glm::vec3>("vec3", sol::constructors<glm::vec3(float, float, float)>(), "x",
                                  &glm::vec3::x, "y", &glm::vec3::y, "z", &glm::vec3::z);

  binding.new_usertype<color>("color", sol::constructors<color(float, float, float, float)>(), "r",
